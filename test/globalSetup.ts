...
const TEST_DB_URL = 'postgresql://postgres:postgress@localhost:5433/sync_server_test';

const DROP_TABLES_SQL = `
DROP TABLE IF EXISTS public.users_pin CASCADE;
DROP TABLE IF EXISTS public.user_tokens CASCADE;
DROP TABLE IF EXISTS public.sync_data CASCADE;
...
export async function setup(): Promise<void> {
  ...
  try {
    await pool.query(DROP_TABLES_SQL);
